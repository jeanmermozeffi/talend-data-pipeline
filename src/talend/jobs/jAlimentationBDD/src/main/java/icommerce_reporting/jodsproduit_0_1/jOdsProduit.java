...
/**
 * Job: jOdsProduit Purpose: jOdsCategorie<br>
...
public static class ProduitAsSousCategorieStruct implements routines.system.IPersistableRow<ProduitAsSousCategorieStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(ProduitAsSousCategorieStruct other) {
...
public static class ProduitNotSousCategorieStruct implements routines.system.IPersistableRow<ProduitNotSousCategorieStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(ProduitNotSousCategorieStruct other) {
...
public static class ListeProduitsStruct implements routines.system.IPersistableRow<ListeProduitsStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(ListeProduitsStruct other) {
...
ListeProduitsStruct ListeProduits = new ListeProduitsStruct();
row2Struct row2 = new row2Struct();
row3Struct row3 = new row3Struct();
ProduitAsSousCategorieStruct ProduitAsSousCategorie = new ProduitAsSousCategorieStruct();
...
ProduitNotSousCategorieStruct ProduitNotSousCategorie = new ProduitNotSousCategorieStruct();
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"PRIX_ACHAT_PRODUIT\",\"PRIX_VENTE_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?)";
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"BL_LIGNE_ACTIVE\" = ? WHERE \"CD_PRODUIT\" = ?";
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	...
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("ODS_PRODUIT");
        ...
        if(updateKeyCount_tDBOutput_3 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_3 == 9 && true) {
...
int count_tDBOutput_3=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_3 = conn_tDBOutput_3.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_3 + "\" WHERE \"CD_PRODUIT\" = ?");
	    resourceMap.put("pstmt_tDBOutput_3", pstmt_tDBOutput_3);
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"PRIX_ACHAT_PRODUIT\",\"PRIX_VENTE_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?)";
	    ...
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"NOM_PRODUIT\" = ?,\"PRIX_ACHAT_PRODUIT\" = ?,\"PRIX_VENTE_PRODUIT\" = ?,\"CD_SOUS_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_PRODUIT\" = ?";
 ...
 */
	...
	currentComponent="tMap_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ProduitAsSousCategorie");
					}
 ...
 */
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ProduitNotSousCategorie");
					}
...
// ###############################
// # Outputs initialization
ProduitAsSousCategorieStruct ProduitAsSousCategorie_tmp = new ProduitAsSousCategorieStruct();
ProduitNotSousCategorieStruct ProduitNotSousCategorie_tmp = new ProduitNotSousCategorieStruct();
// ###############################
 ...
 */
	...
	currentComponent="tFilterRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ListeProduits");
					}
...
// ###############################
// # Outputs initialization
ListeProduitsStruct ListeProduits_tmp = new ListeProduitsStruct();
// ###############################
...
// # Output table : 'ListeProduits'
ListeProduits_tmp.CD_PRODUIT = row1.CD_PRODUIT ;
ListeProduits_tmp.NOM_PRODUIT = row1.NOM_PRODUIT ;
ListeProduits_tmp.PRIX_ACHAT_PRODUIT = row1.PRIX_ACHAT_PRODUIT ;
ListeProduits_tmp.PRIX_VENTE_PRODUIT = row1.PRIX_VENTE_PRODUIT ;
ListeProduits_tmp.CD_SOUS_CATEGORIE = row1.CD_SOUS_CATEGORIE ;
ListeProduits_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1) ;
ListeProduits = ListeProduits_tmp;
// ###############################
...
if(ListeProduits != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((!ListeProduits.CD_PRODUIT.isEmpty() 
&& !ListeProduits.NOM_PRODUIT.isEmpty() 
&& ListeProduits.PRIX_ACHAT_PRODUIT!=null
&& ListeProduits.PRIX_VENTE_PRODUIT!=null
&& !ListeProduits.CD_SOUS_CATEGORIE.isEmpty()
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.CD_PRODUIT = ListeProduits.CD_PRODUIT;
               row2.NOM_PRODUIT = ListeProduits.NOM_PRODUIT;
               row2.PRIX_ACHAT_PRODUIT = ListeProduits.PRIX_ACHAT_PRODUIT;
               row2.PRIX_VENTE_PRODUIT = ListeProduits.PRIX_VENTE_PRODUIT;
               row2.CD_SOUS_CATEGORIE = ListeProduits.CD_SOUS_CATEGORIE;
               row2.NUM_LIGNE = ListeProduits.NUM_LIGNE;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (row5 == null){
              row5 = new row5Struct();
            }
                row5.CD_PRODUIT = ListeProduits.CD_PRODUIT;
                row5.NOM_PRODUIT = ListeProduits.NOM_PRODUIT;
                row5.PRIX_ACHAT_PRODUIT = ListeProduits.PRIX_ACHAT_PRODUIT;
                row5.PRIX_VENTE_PRODUIT = ListeProduits.PRIX_VENTE_PRODUIT;
                row5.CD_SOUS_CATEGORIE = ListeProduits.CD_SOUS_CATEGORIE;
                row5.NUM_LIGNE = ListeProduits.NUM_LIGNE;
...
ProduitAsSousCategorie = null;
ProduitNotSousCategorie = null;

if(!rejectedInnerJoin_tMap_5 ) {

// # Output table : 'ProduitAsSousCategorie'
ProduitAsSousCategorie_tmp.CD_PRODUIT = row3.CD_PRODUIT ;
ProduitAsSousCategorie_tmp.NOM_PRODUIT = row3.NOM_PRODUIT ;
ProduitAsSousCategorie_tmp.PRIX_ACHAT_PRODUIT = row3.PRIX_ACHAT_PRODUIT ;
ProduitAsSousCategorie_tmp.PRIX_VENTE_PRODUIT = row3.PRIX_VENTE_PRODUIT ;
ProduitAsSousCategorie_tmp.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE ;
ProduitAsSousCategorie_tmp.NUM_LIGNE = row3.NUM_LIGNE ;
ProduitAsSousCategorie = ProduitAsSousCategorie_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'ProduitNotSousCategorie'
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
ProduitNotSousCategorie_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
ProduitNotSousCategorie_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
ProduitNotSousCategorie_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
ProduitNotSousCategorie_tmp.LB_LIGNE_REJET = row3.CD_PRODUIT +'|'+ row3.NOM_PRODUIT +'|'+ row3.PRIX_ACHAT_PRODUIT +'|'+ row3.PRIX_VENTE_PRODUIT +'|'+ row3.CD_SOUS_CATEGORIE ;
ProduitNotSousCategorie_tmp.LB_MESSAGE_REJET = "La dépendance ==> :" + row3.CD_SOUS_CATEGORIE + "n'existe dans la donnée fournie." ;
ProduitNotSousCategorie_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
ProduitNotSousCategorie_tmp.DT_REJET = TalendDate.getCurrentDate();
ProduitNotSousCategorie_tmp.LB_JOB_NAME = jobName;
ProduitNotSousCategorie = ProduitNotSousCategorie_tmp;
 ...
 */
// Start of branch "ProduitAsSousCategorie"
if(ProduitAsSousCategorie != null) { 
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_PRODUIT = ProduitAsSousCategorie.CD_PRODUIT ;
                        		    		
                        		    		    row7HashKey.CD_SOUS_CATEGORIE = ProduitAsSousCategorie.CD_SOUS_CATEGORIE ;
								  ...
								  if(!tHash_Lookup_row7.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.CD_PRODUIT = '" + row7HashKey.CD_PRODUIT + "', row7.CD_SOUS_CATEGORIE = '" + row7HashKey.CD_SOUS_CATEGORIE + "'");
								} // G 071
...
!ProduitAsSousCategorie.NOM_PRODUIT.equals(row7.NOM_PRODUIT)
|| ProduitAsSousCategorie.PRIX_ACHAT_PRODUIT.compareTo(row7.PRIX_ACHAT_PRODUIT)!=0
|| ProduitAsSousCategorie.PRIX_VENTE_PRODUIT.compareTo(row7.PRIX_VENTE_PRODUIT)!=0
|| !ProduitAsSousCategorie.CD_SOUS_CATEGORIE.equals(row7.CD_SOUS_CATEGORIE)

 ) {
UpdateData_tmp.CD_PRODUIT = ProduitAsSousCategorie.CD_PRODUIT ;
...
InsertNewValueData_tmp.CD_PRODUIT = ProduitAsSousCategorie.CD_PRODUIT ;
InsertNewValueData_tmp.NOM_PRODUIT = ProduitAsSousCategorie.NOM_PRODUIT ;
InsertNewValueData_tmp.PRIX_ACHAT_PRODUIT = ProduitAsSousCategorie.PRIX_ACHAT_PRODUIT ;
InsertNewValueData_tmp.PRIX_VENTE_PRODUIT = ProduitAsSousCategorie.PRIX_VENTE_PRODUIT ;
InsertNewValueData_tmp.CD_SOUS_CATEGORIE = ProduitAsSousCategorie.CD_SOUS_CATEGORIE ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
InsertData_tmp.CD_PRODUIT = ProduitAsSousCategorie.CD_PRODUIT ;
InsertData_tmp.NOM_PRODUIT = ProduitAsSousCategorie.NOM_PRODUIT ;
InsertData_tmp.PRIX_ACHAT_PRODUIT = ProduitAsSousCategorie.PRIX_ACHAT_PRODUIT ;
InsertData_tmp.PRIX_VENTE_PRODUIT = ProduitAsSousCategorie.PRIX_VENTE_PRODUIT ;
InsertData_tmp.CD_SOUS_CATEGORIE =  ProduitAsSousCategorie.CD_SOUS_CATEGORIE ;
...
} else {pstmt_tDBOutput_1.setString(6, InsertData.LB_NOM_FICHIER);
}

                    if(InsertData.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(InsertData.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setInt(8, InsertData.BL_LIGNE_ACTIVE);

                    if(InsertData.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, InsertData.LB_JOB_NAME);
}
...
if(UpdateData != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    ...
                    if(UpdateData.CD_PRODUIT == null) {
pstmt_tDBOutput_2.setNull(2 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2 + count_tDBOutput_2, UpdateData.CD_PRODUIT);
}
...
if(InsertNewValueData != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(InsertNewValueData.CD_PRODUIT == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, InsertNewValueData.CD_PRODUIT);
}
            ...
            if(checkCount_tDBOutput_3 > 0) {
                        if(InsertNewValueData.NOM_PRODUIT == null) {
pstmtUpdate_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(1, InsertNewValueData.NOM_PRODUIT);
}

                        pstmtUpdate_tDBOutput_3.setBigDecimal(2, InsertNewValueData.PRIX_ACHAT_PRODUIT);

                        pstmtUpdate_tDBOutput_3.setBigDecimal(3, InsertNewValueData.PRIX_VENTE_PRODUIT);

                        if(InsertNewValueData.CD_SOUS_CATEGORIE == null) {
pstmtUpdate_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(4, InsertNewValueData.CD_SOUS_CATEGORIE);
}

                        if(InsertNewValueData.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5, InsertNewValueData.LB_NOM_FICHIER);
}

                        if(InsertNewValueData.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(6, new java.sql.Timestamp(InsertNewValueData.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_3.setNull(6, java.sql.Types.TIMESTAMP);
}

                        pstmtUpdate_tDBOutput_3.setInt(7, InsertNewValueData.BL_LIGNE_ACTIVE);

                        if(InsertNewValueData.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(8, InsertNewValueData.LB_JOB_NAME);
}

                        if(InsertNewValueData.CD_PRODUIT == null) {
pstmtUpdate_tDBOutput_3.setNull(9 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(9 + count_tDBOutput_3, InsertNewValueData.CD_PRODUIT);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, InsertNewValueData.CD_PRODUIT);
}

                        if(InsertNewValueData.NOM_PRODUIT == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(2, InsertNewValueData.NOM_PRODUIT);
}

                        pstmtInsert_tDBOutput_3.setBigDecimal(3, InsertNewValueData.PRIX_ACHAT_PRODUIT);

                        pstmtInsert_tDBOutput_3.setBigDecimal(4, InsertNewValueData.PRIX_VENTE_PRODUIT);

                        if(InsertNewValueData.CD_SOUS_CATEGORIE == null) {
pstmtInsert_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(5, InsertNewValueData.CD_SOUS_CATEGORIE);
}

                        if(InsertNewValueData.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, InsertNewValueData.LB_NOM_FICHIER);
}

                        if(InsertNewValueData.DT_INSERTION != null) {
pstmtInsert_tDBOutput_3.setTimestamp(7, new java.sql.Timestamp(InsertNewValueData.DT_INSERTION.getTime()));
} else {
pstmtInsert_tDBOutput_3.setNull(7, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_3.setInt(8, InsertNewValueData.BL_LIGNE_ACTIVE);

                        if(InsertNewValueData.LB_JOB_NAME == null) {
pstmtInsert_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(9, InsertNewValueData.LB_JOB_NAME);
}
...
} // End of branch "ProduitAsSousCategorie"




// Start of branch "ProduitNotSousCategorie"
if(ProduitNotSousCategorie != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(ProduitNotSousCategorie.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(1, ProduitNotSousCategorie.LB_CHEMIN_FICHIER);
}

                    if(ProduitNotSousCategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, ProduitNotSousCategorie.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, ProduitNotSousCategorie.NUM_LIGNE_REJET);

                    if(ProduitNotSousCategorie.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, ProduitNotSousCategorie.LB_LIGNE_REJET);
}

                    if(ProduitNotSousCategorie.LB_MESSAGE_REJET == null) {
pstmt_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(5, ProduitNotSousCategorie.LB_MESSAGE_REJET);
}

                    if(ProduitNotSousCategorie.LB_NOM_FLUX == null) {
pstmt_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(6, ProduitNotSousCategorie.LB_NOM_FLUX);
}

                    if(ProduitNotSousCategorie.DT_REJET != null) {
pstmt_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(ProduitNotSousCategorie.DT_REJET.getTime()));
} else {
pstmt_tDBOutput_6.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(ProduitNotSousCategorie.LB_JOB_NAME == null) {
pstmt_tDBOutput_6.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(8, ProduitNotSousCategorie.LB_JOB_NAME);
}
...
} // End of branch "ProduitNotSousCategorie"
...
InsertDuplicate_tmp.LB_LIGNE_REJET = row5.CD_PRODUIT +'|'+ row5.NOM_PRODUIT +'|'+ row5.PRIX_ACHAT_PRODUIT +'|'+ row5.PRIX_VENTE_PRODUIT +'|'+ row5.CD_SOUS_CATEGORIE ;
 ...
 */
    ...
    globalMap.put("tFilterRow_1_NB_LINE_REJECT", nb_line_reject_tFilterRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ListeProduits");
			  	}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ProduitAsSousCategorie");
			  	}
...
globalMap.put("tDBOutput_6_ERROR_MESSAGE",e_tDBOutput_6.getMessage());
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ProduitNotSousCategorie");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(ProduitAsSousCategorie,row7) outputs:(InsertData,UpdateData,InsertNewValueData)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(row3,row4) outputs:(ProduitAsSousCategorie,ProduitNotSousCategorie)
...
/************************************************************************************************
 *     369008 characters generated by Talend Open Studio for Data Integration 
