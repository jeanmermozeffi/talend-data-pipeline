...
package icommerce_reporting.jodsclient_0_1;
...
/**
 * Job: jOdsClient Purpose: jOdsCategorie<br>
 * Description: jOdsCategorie <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jOdsClient implements TalendJob {
...
public String getFieldSeparator(){
	...
	private final String jobName = "jOdsClient";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jOdsClient.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ICOMMERCE_REPORTING_jOdsClient.length) {
				if(length < 1024 && commonByteArray_ICOMMERCE_REPORTING_jOdsClient.length == 0) {
   					commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[1024];
				} else {
   					commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ICOMMERCE_REPORTING_jOdsClient, 0, length);
			strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jOdsClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ICOMMERCE_REPORTING_jOdsClient, 0, length);
			strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jOdsClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient) {
...
globalMap.put("masque_fichier", "ICOM_*_CUSTOMER.csv");
globalMap.put("nom_flux", "CLIENT");
...
public static class InsertNewValueDataStruct implements routines.system.IPersistableRow<InsertNewValueDataStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final InsertNewValueDataStruct other = (InsertNewValueDataStruct) obj;
	...
	public void copyDataTo(InsertNewValueDataStruct other) {
	...
	public void copyKeysDataTo(InsertNewValueDataStruct other) {
...
public static class ClinetsTypeStruct implements routines.system.IPersistableRow<ClinetsTypeStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(ClinetsTypeStruct other) {
...
public static class ClientTypeManquantStruct implements routines.system.IPersistableRow<ClientTypeManquantStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(ClientTypeManquantStruct other) {
...
ClinetsTypeStruct ClinetsType = new ClinetsTypeStruct();
...
ClientTypeManquantStruct ClientTypeManquant = new ClientTypeManquantStruct();
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ODS_CLIENT");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ODS_CLIENT");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"ID_CLIENT\",\"NOM_CLIENT\",\"PREN_CLIENT\",\"CD_POSTAL_CLIENT\",\"VILLE_CLIENT\",\"PAYS_CLIENT\",\"REGION_CLIENT\",\"CD_TYPE_CLIENT\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("ODS_CLIENT");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("ODS_CLIENT");
}
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"BL_LIGNE_ACTIVE\" = ? WHERE \"ID_CLIENT\" = ?";
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("ODS_CLIENT");
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("ODS_CLIENT");
}
...
int count_tDBOutput_3=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_3 = conn_tDBOutput_3.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_3 + "\" WHERE \"ID_CLIENT\" = ?");
	    resourceMap.put("pstmt_tDBOutput_3", pstmt_tDBOutput_3);
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"ID_CLIENT\",\"NOM_CLIENT\",\"PREN_CLIENT\",\"CD_POSTAL_CLIENT\",\"VILLE_CLIENT\",\"PAYS_CLIENT\",\"REGION_CLIENT\",\"CD_TYPE_CLIENT\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
	    ...
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"NOM_CLIENT\" = ?,\"PREN_CLIENT\" = ?,\"CD_POSTAL_CLIENT\" = ?,\"VILLE_CLIENT\" = ?,\"PAYS_CLIENT\" = ?,\"REGION_CLIENT\" = ?,\"CD_TYPE_CLIENT\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"ID_CLIENT\" = ?";
 ...
 */
	...
	currentComponent="tMap_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ClinetsType");
					}
 ...
 */
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ClientTypeManquant");
					}
...
// ###############################
// # Outputs initialization
ClinetsTypeStruct ClinetsType_tmp = new ClinetsTypeStruct();
ClientTypeManquantStruct ClientTypeManquant_tmp = new ClientTypeManquantStruct();
// ###############################
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
							...
							row1.CD_POSTAL_CLIENT = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
Clients_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1)  ;
Clients = Clients_tmp;
// ###############################
...
if(Clients != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((!Clients.ID_CLIENT.isEmpty() 
&& !Clients.NOM_CLIENT.isEmpty() 
&& !Clients.PREN_CLIENT.isEmpty()
&& !Clients.VILLE_CLIENT.isEmpty()
&& !Clients.PAYS_CLIENT.isEmpty() 
&& !Clients.REGION_CLIENT.isEmpty() 
&& !Clients.CD_TYPE_CLIENT.isEmpty()
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.ID_CLIENT = Clients.ID_CLIENT;
               row2.NOM_CLIENT = Clients.NOM_CLIENT;
               row2.PREN_CLIENT = Clients.PREN_CLIENT;
               row2.CD_POSTAL_CLIENT = Clients.CD_POSTAL_CLIENT;
               row2.VILLE_CLIENT = Clients.VILLE_CLIENT;
               row2.PAYS_CLIENT = Clients.PAYS_CLIENT;
               row2.REGION_CLIENT = Clients.REGION_CLIENT;
               row2.CD_TYPE_CLIENT = Clients.CD_TYPE_CLIENT;
               row2.NUM_LIGNE = Clients.NUM_LIGNE;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (row5 == null){
              row5 = new row5Struct();
            }
                row5.ID_CLIENT = Clients.ID_CLIENT;
                row5.NOM_CLIENT = Clients.NOM_CLIENT;
                row5.PREN_CLIENT = Clients.PREN_CLIENT;
                row5.CD_POSTAL_CLIENT = Clients.CD_POSTAL_CLIENT;
                row5.VILLE_CLIENT = Clients.VILLE_CLIENT;
                row5.PAYS_CLIENT = Clients.PAYS_CLIENT;
                row5.REGION_CLIENT = Clients.REGION_CLIENT;
                row5.CD_TYPE_CLIENT = Clients.CD_TYPE_CLIENT;
                row5.NUM_LIGNE = Clients.NUM_LIGNE;
...
if(row2.ID_CLIENT == null){
	finder_tUniqRow_1.ID_CLIENT = null;
}else{
	finder_tUniqRow_1.ID_CLIENT = row2.ID_CLIENT.toLowerCase();
}	
...
if(row2.ID_CLIENT == null){
	new_tUniqRow_1.ID_CLIENT = null;
}else{
	new_tUniqRow_1.ID_CLIENT = row2.ID_CLIENT.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.ID_CLIENT = row2.ID_CLIENT;			row3.NOM_CLIENT = row2.NOM_CLIENT;			row3.PREN_CLIENT = row2.PREN_CLIENT;			row3.CD_POSTAL_CLIENT = row2.CD_POSTAL_CLIENT;			row3.VILLE_CLIENT = row2.VILLE_CLIENT;			row3.PAYS_CLIENT = row2.PAYS_CLIENT;			row3.REGION_CLIENT = row2.REGION_CLIENT;			row3.CD_TYPE_CLIENT = row2.CD_TYPE_CLIENT;			row3.NUM_LIGNE = row2.NUM_LIGNE;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row6 == null){ 
	
	row6 = new row6Struct();
}				row6.ID_CLIENT = row2.ID_CLIENT;			row6.NOM_CLIENT = row2.NOM_CLIENT;			row6.PREN_CLIENT = row2.PREN_CLIENT;			row6.CD_POSTAL_CLIENT = row2.CD_POSTAL_CLIENT;			row6.VILLE_CLIENT = row2.VILLE_CLIENT;			row6.PAYS_CLIENT = row2.PAYS_CLIENT;			row6.REGION_CLIENT = row2.REGION_CLIENT;			row6.CD_TYPE_CLIENT = row2.CD_TYPE_CLIENT;			row6.NUM_LIGNE = row2.NUM_LIGNE;			
...
ClinetsType = null;
ClientTypeManquant = null;

if(!rejectedInnerJoin_tMap_5 ) {

// # Output table : 'ClinetsType'
ClinetsType_tmp.ID_CLIENT = row3.ID_CLIENT ;
ClinetsType_tmp.NOM_CLIENT = row3.NOM_CLIENT;
ClinetsType_tmp.PREN_CLIENT = row3.PREN_CLIENT;
ClinetsType_tmp.CD_POSTAL_CLIENT = row3.CD_POSTAL_CLIENT ;
ClinetsType_tmp.VILLE_CLIENT = row3.VILLE_CLIENT ;
ClinetsType_tmp.PAYS_CLIENT = row3.PAYS_CLIENT ;
ClinetsType_tmp.REGION_CLIENT = row3.REGION_CLIENT ;
ClinetsType_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT ;
ClinetsType_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
ClinetsType_tmp.DT_INSERTION = TalendDate.getCurrentDate();
ClinetsType_tmp.BL_LIGNE_ACTIVE = 1;
ClinetsType_tmp.LB_JOB_NAME = jobName;
ClinetsType = ClinetsType_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'ClientTypeManquant'
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
ClientTypeManquant_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
ClientTypeManquant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
ClientTypeManquant_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
ClientTypeManquant_tmp.LB_LIGNE_REJET = row3.ID_CLIENT + '|' + row3.NOM_CLIENT + '|' + row3.PREN_CLIENT + '|' + row3.CD_POSTAL_CLIENT + '|' + row3.VILLE_CLIENT + '|' + row3.PAYS_CLIENT + '|' + row3.REGION_CLIENT + '|' + row3.CD_TYPE_CLIENT ;
ClientTypeManquant_tmp.LB_MESSAGE_REJET = "Dépendance ==> : " + row3.CD_TYPE_CLIENT + "n'existe pas dans la donnée fournie." ;
ClientTypeManquant_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
ClientTypeManquant_tmp.DT_REJET = TalendDate.getCurrentDate();
ClientTypeManquant_tmp.LB_JOB_NAME = jobName;
ClientTypeManquant = ClientTypeManquant_tmp;
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row7HashKey.ID_CLIENT = ClinetsType.ID_CLIENT ;
...
UpdateData_tmp.ID_CLIENT = ClinetsType.ID_CLIENT ;
...
!ClinetsType.NOM_CLIENT.equals(row7.NOM_CLIENT)
|| !ClinetsType.PREN_CLIENT.equals(row7.PREN_CLIENT)
|| !ClinetsType.CD_POSTAL_CLIENT.equals(row7.CD_POSTAL_CLIENT)
|| !ClinetsType.VILLE_CLIENT.equals(row7.VILLE_CLIENT)
|| !ClinetsType.PAYS_CLIENT.equals(row7.PAYS_CLIENT)
|| !ClinetsType.REGION_CLIENT.equals(row7.REGION_CLIENT)
|| !ClinetsType.CD_TYPE_CLIENT.equals(row7.CD_TYPE_CLIENT)

 ) {
InsertNewValueData_tmp.ID_CLIENT = ClinetsType.ID_CLIENT ;
InsertNewValueData_tmp.NOM_CLIENT = ClinetsType.NOM_CLIENT;
InsertNewValueData_tmp.PREN_CLIENT = ClinetsType.PREN_CLIENT ;
InsertNewValueData_tmp.CD_POSTAL_CLIENT = ClinetsType.CD_POSTAL_CLIENT ;
InsertNewValueData_tmp.VILLE_CLIENT = ClinetsType.VILLE_CLIENT ;
InsertNewValueData_tmp.PAYS_CLIENT = ClinetsType.PAYS_CLIENT ;
InsertNewValueData_tmp.REGION_CLIENT = ClinetsType.REGION_CLIENT ;
InsertNewValueData_tmp.CD_TYPE_CLIENT = ClinetsType.CD_TYPE_CLIENT ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
InsertData_tmp.ID_CLIENT = ClinetsType.ID_CLIENT;
InsertData_tmp.NOM_CLIENT = ClinetsType.NOM_CLIENT ;
InsertData_tmp.PREN_CLIENT = ClinetsType.PREN_CLIENT   ;
InsertData_tmp.CD_POSTAL_CLIENT = ClinetsType.CD_POSTAL_CLIENT ;
InsertData_tmp.VILLE_CLIENT =  ClinetsType.VILLE_CLIENT ;
InsertData_tmp.PAYS_CLIENT = ClinetsType.PAYS_CLIENT ;
InsertData_tmp.REGION_CLIENT = ClinetsType.REGION_CLIENT ;
InsertData_tmp.CD_TYPE_CLIENT = ClinetsType.CD_TYPE_CLIENT ;
...
} else {pstmt_tDBOutput_1.setString(9, InsertData.LB_NOM_FICHIER);
}
...
if(UpdateData != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    pstmt_tDBOutput_2.setInt(1, UpdateData.BL_LIGNE_ACTIVE);

                    if(UpdateData.ID_CLIENT == null) {
pstmt_tDBOutput_2.setNull(2 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2 + count_tDBOutput_2, UpdateData.ID_CLIENT);
}
...
if(InsertNewValueData != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(InsertNewValueData.ID_CLIENT == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, InsertNewValueData.ID_CLIENT);
}
            ...
            if(checkCount_tDBOutput_3 > 0) {
                        if(InsertNewValueData.NOM_CLIENT == null) {
pstmtUpdate_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(1, InsertNewValueData.NOM_CLIENT);
}

                        if(InsertNewValueData.PREN_CLIENT == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(2, InsertNewValueData.PREN_CLIENT);
}

                        if(InsertNewValueData.CD_POSTAL_CLIENT == null) {
pstmtUpdate_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(3, InsertNewValueData.CD_POSTAL_CLIENT);
}

                        if(InsertNewValueData.VILLE_CLIENT == null) {
pstmtUpdate_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(4, InsertNewValueData.VILLE_CLIENT);
}

                        if(InsertNewValueData.PAYS_CLIENT == null) {
pstmtUpdate_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5, InsertNewValueData.PAYS_CLIENT);
}

                        if(InsertNewValueData.REGION_CLIENT == null) {
pstmtUpdate_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(6, InsertNewValueData.REGION_CLIENT);
}

                        if(InsertNewValueData.CD_TYPE_CLIENT == null) {
pstmtUpdate_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(7, InsertNewValueData.CD_TYPE_CLIENT);
}

                        if(InsertNewValueData.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(8, InsertNewValueData.LB_NOM_FICHIER);
}

                        if(InsertNewValueData.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(9, new java.sql.Timestamp(InsertNewValueData.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_3.setNull(9, java.sql.Types.TIMESTAMP);
}

                        pstmtUpdate_tDBOutput_3.setInt(10, InsertNewValueData.BL_LIGNE_ACTIVE);

                        if(InsertNewValueData.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_3.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(11, InsertNewValueData.LB_JOB_NAME);
}

                        if(InsertNewValueData.ID_CLIENT == null) {
pstmtUpdate_tDBOutput_3.setNull(12 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(12 + count_tDBOutput_3, InsertNewValueData.ID_CLIENT);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, InsertNewValueData.ID_CLIENT);
}

                        if(InsertNewValueData.NOM_CLIENT == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(2, InsertNewValueData.NOM_CLIENT);
}

                        if(InsertNewValueData.PREN_CLIENT == null) {
pstmtInsert_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(3, InsertNewValueData.PREN_CLIENT);
}

                        if(InsertNewValueData.CD_POSTAL_CLIENT == null) {
pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(4, InsertNewValueData.CD_POSTAL_CLIENT);
}

                        if(InsertNewValueData.VILLE_CLIENT == null) {
pstmtInsert_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(5, InsertNewValueData.VILLE_CLIENT);
}

                        if(InsertNewValueData.PAYS_CLIENT == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, InsertNewValueData.PAYS_CLIENT);
}

                        if(InsertNewValueData.REGION_CLIENT == null) {
pstmtInsert_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(7, InsertNewValueData.REGION_CLIENT);
}

                        if(InsertNewValueData.CD_TYPE_CLIENT == null) {
pstmtInsert_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(8, InsertNewValueData.CD_TYPE_CLIENT);
}

                        if(InsertNewValueData.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(9, InsertNewValueData.LB_NOM_FICHIER);
}

                        if(InsertNewValueData.DT_INSERTION != null) {
pstmtInsert_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(InsertNewValueData.DT_INSERTION.getTime()));
} else {
pstmtInsert_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_3.setInt(11, InsertNewValueData.BL_LIGNE_ACTIVE);

                        if(InsertNewValueData.LB_JOB_NAME == null) {
pstmtInsert_tDBOutput_3.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(12, InsertNewValueData.LB_JOB_NAME);
}
...
} // End of branch "ClinetsType"




// Start of branch "ClientTypeManquant"
if(ClientTypeManquant != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(ClientTypeManquant.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(1, ClientTypeManquant.LB_CHEMIN_FICHIER);
}

                    if(ClientTypeManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, ClientTypeManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, ClientTypeManquant.NUM_LIGNE_REJET);

                    if(ClientTypeManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, ClientTypeManquant.LB_LIGNE_REJET);
}

                    if(ClientTypeManquant.LB_MESSAGE_REJET == null) {
pstmt_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(5, ClientTypeManquant.LB_MESSAGE_REJET);
}

                    if(ClientTypeManquant.LB_NOM_FLUX == null) {
pstmt_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(6, ClientTypeManquant.LB_NOM_FLUX);
}

                    if(ClientTypeManquant.DT_REJET != null) {
pstmt_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(ClientTypeManquant.DT_REJET.getTime()));
} else {
pstmt_tDBOutput_6.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(ClientTypeManquant.LB_JOB_NAME == null) {
pstmt_tDBOutput_6.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(8, ClientTypeManquant.LB_JOB_NAME);
}
...
} // End of branch "ClientTypeManquant"
...
InsertDuplicate_tmp.LB_LIGNE_REJET = row6.ID_CLIENT + '|' + row6.NOM_CLIENT +'|' +  row6.PREN_CLIENT + '|' + row6.CD_POSTAL_CLIENT +'|' +  row6.VILLE_CLIENT + '|' + row6.PAYS_CLIENT +'|' + row6.REGION_CLIENT + '|' +  row6.CD_TYPE_CLIENT ;
...
InsertReject_tmp.LB_LIGNE_REJET = row5.ID_CLIENT + '|' + row5.NOM_CLIENT + '|' + row5.PREN_CLIENT + '|' + row5.CD_POSTAL_CLIENT  + '|' + row5.VILLE_CLIENT  + '|' + row5.PAYS_CLIENT + '|' + row5.REGION_CLIENT + '|' + row5.CD_TYPE_CLIENT ;
InsertReject_tmp.LB_MESSAGE_REJET = "Données manquantes";
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ClinetsType");
			  	}
...
globalMap.put("tDBOutput_6_ERROR_MESSAGE",e_tDBOutput_6.getMessage());
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ClientTypeManquant");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(row3,row4) outputs:(ClinetsType,ClientTypeManquant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(ClinetsType,row7) outputs:(InsertData,UpdateData,InsertNewValueData)
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_2 = null;
				...
				String dbUser_tDBInput_2 = context.postgres_user;
				
				
	final String decryptedPassword_tDBInput_2 = context.postgres_password; 
				
				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;
				
				String url_tDBInput_2 = "jdbc:postgresql://" + context.server_name + ":" + context.port + "/" + context.database + "?" + context.additinal_params;
 ...
 */
    ...
    public static void main(String[] args){
        final jOdsClient jOdsClientClass = new jOdsClient();

        int exitCode = jOdsClientClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsClient.class.getClassLoader().getResourceAsStream("icommerce_reporting/jodsclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jOdsClient.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jOdsClient");
        }
...
/************************************************************************************************
 *     381513 characters generated by Talend Open Studio for Data Integration 
 *     on the 26 février 2025 à 12:11:48 GMT
 ************************************************************************************************/