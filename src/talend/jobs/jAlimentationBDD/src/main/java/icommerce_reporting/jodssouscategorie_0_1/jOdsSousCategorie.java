...
package icommerce_reporting.jodssouscategorie_0_1;
...
/**
 * Job: jOdsSousCategorie Purpose: jOdsCategorie<br>
 * Description: jOdsCategorie <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jOdsSousCategorie implements TalendJob {
...
public String getFieldSeparator(){
	...
	private final String jobName = "jOdsSousCategorie";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jOdsSousCategorie.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jOdsSousCategorie.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie.length) {
				if(length < 1024 && commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie.length == 0) {
   					commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[1024];
				} else {
   					commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie, 0, length);
			strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie, 0, length);
			strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie) {
...
globalMap.put("masque_fichier", "ICOM_*_SOUS_CATEGORIE.csv");
globalMap.put("nom_flux", "SOUS_CATEGORIE");
...
public static class SousCategorieStruct implements routines.system.IPersistableRow<SousCategorieStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(SousCategorieStruct other) {
...
public static class CategorieManquanteStruct implements routines.system.IPersistableRow<CategorieManquanteStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(CategorieManquanteStruct other) {
...
SousCategorieStruct SousCategorie = new SousCategorieStruct();
...
CategorieManquanteStruct CategorieManquante = new CategorieManquanteStruct();
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("ODS_SOUS_CATEGORIE");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("ODS_SOUS_CATEGORIE");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?)";
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ODS_SOUS_CATEGORIE");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ODS_SOUS_CATEGORIE");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"BL_LIGNE_ACTIVE\" = ? WHERE \"CD_SOUS_CATEGORIE\" = ?";
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("ODS_SOUS_CATEGORIE");
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("ODS_SOUS_CATEGORIE");
}
...
int count_tDBOutput_3=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_3 = conn_tDBOutput_3.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_3 + "\" WHERE \"CD_CATEGORIE\" = ?");
	    resourceMap.put("pstmt_tDBOutput_3", pstmt_tDBOutput_3);
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?)";
	    ...
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"CD_SOUS_CATEGORIE\" = ?,\"LB_SOUS_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_CATEGORIE\" = ?";
 ...
 */
	...
	currentComponent="tMap_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"SousCategorie");
					}
 ...
 */
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"CategorieManquante");
					}
...
// ###############################
// # Outputs initialization
SousCategorieStruct SousCategorie_tmp = new SousCategorieStruct();
CategorieManquanteStruct CategorieManquante_tmp = new CategorieManquanteStruct();
// ###############################
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							row1.LB_SOUS_CATEGORIE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
Type_Client_tmp.CD_SOUS_CATEGORIE = row1.CD_SOUS_CATEGORIE ;
Type_Client_tmp.LB_SOUS_CATEGORIE = row1.LB_SOUS_CATEGORIE ;
Type_Client_tmp.CD_CATEGORIE = row1.CD_CATEGORIE ;
...
if(Type_Client != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((!Type_Client.CD_SOUS_CATEGORIE.isEmpty() && !Type_Client.LB_SOUS_CATEGORIE.isEmpty() && !Type_Client.CD_CATEGORIE.isEmpty()
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.CD_SOUS_CATEGORIE = Type_Client.CD_SOUS_CATEGORIE;
               row2.LB_SOUS_CATEGORIE = Type_Client.LB_SOUS_CATEGORIE;
               row2.CD_CATEGORIE = Type_Client.CD_CATEGORIE;
      ...
      nb_line_ok_tFilterRow_1++;
            ...
            if (row5 == null){
              row5 = new row5Struct();
                ...
                row5.CD_SOUS_CATEGORIE = Type_Client.CD_SOUS_CATEGORIE;
                row5.LB_SOUS_CATEGORIE = Type_Client.LB_SOUS_CATEGORIE;
                row5.CD_CATEGORIE = Type_Client.CD_CATEGORIE;
...
if(row2.CD_SOUS_CATEGORIE == null){
	finder_tUniqRow_1.CD_SOUS_CATEGORIE = null;
}else{
	finder_tUniqRow_1.CD_SOUS_CATEGORIE = row2.CD_SOUS_CATEGORIE.toLowerCase();
}	
...
if(row2.CD_SOUS_CATEGORIE == null){
	new_tUniqRow_1.CD_SOUS_CATEGORIE = null;
}else{
	new_tUniqRow_1.CD_SOUS_CATEGORIE = row2.CD_SOUS_CATEGORIE.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.CD_SOUS_CATEGORIE = row2.CD_SOUS_CATEGORIE;			row3.LB_SOUS_CATEGORIE = row2.LB_SOUS_CATEGORIE;			row3.CD_CATEGORIE = row2.CD_CATEGORIE;			row3.NUM_LIGNE = row2.NUM_LIGNE;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row6 == null){ 
	
	row6 = new row6Struct();
}				row6.CD_SOUS_CATEGORIE = row2.CD_SOUS_CATEGORIE;			row6.LB_SOUS_CATEGORIE = row2.LB_SOUS_CATEGORIE;			row6.CD_CATEGORIE = row2.CD_CATEGORIE;			row6.NUM_LIGNE = row2.NUM_LIGNE;			
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_CATEGORIE = row3.CD_CATEGORIE ;
								  ...
								  if(!tHash_Lookup_row7.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.CD_CATEGORIE = '" + row7HashKey.CD_CATEGORIE + "'");
								} // G 071
...
SousCategorie = null;
CategorieManquante = null;

if(!rejectedInnerJoin_tMap_5 ) {

// # Output table : 'SousCategorie'
SousCategorie_tmp.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE ;
SousCategorie_tmp.LB_SOUS_CATEGORIE = row3.LB_SOUS_CATEGORIE ;
SousCategorie_tmp.CD_CATEGORIE = row3.CD_CATEGORIE ;
SousCategorie_tmp.NUM_LIGNE = row3.NUM_LIGNE ;
SousCategorie = SousCategorie_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'CategorieManquante'
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
CategorieManquante_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
CategorieManquante_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
CategorieManquante_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
CategorieManquante_tmp.LB_LIGNE_REJET = row3.CD_SOUS_CATEGORIE + '|' + row3.LB_SOUS_CATEGORIE + '|' + row3.CD_CATEGORIE ;
CategorieManquante_tmp.LB_MESSAGE_REJET = "Dependance ==> la Categorie :" + row3.CD_CATEGORIE + "n'existe pas dans la table ODS_CATEGORIE" ;
CategorieManquante_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
CategorieManquante_tmp.DT_REJET = TalendDate.getCurrentDate();
CategorieManquante_tmp.LB_JOB_NAME = jobName;
CategorieManquante = CategorieManquante_tmp;
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row4HashKey.CD_CATEGORIE = SousCategorie.CD_CATEGORIE ;
...
UpdateData_tmp.CD_SOUS_CATEGORIE = SousCategorie.CD_SOUS_CATEGORIE ;
...
!SousCategorie.LB_SOUS_CATEGORIE.equals(row4.LB_SOUS_CATEGORIE) 
|| !SousCategorie.CD_CATEGORIE.equals(row4.CD_CATEGORIE)

 ) {
InsertNewValueData_tmp.CD_SOUS_CATEGORIE = SousCategorie.CD_SOUS_CATEGORIE;
InsertNewValueData_tmp.LB_SOUS_CATEGORIE = SousCategorie.LB_SOUS_CATEGORIE ;
InsertNewValueData_tmp.CD_CATEGORIE = SousCategorie.CD_CATEGORIE ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
InsertData_tmp.CD_SOUS_CATEGORIE = SousCategorie.CD_SOUS_CATEGORIE ;
InsertData_tmp.LB_SOUS_CATEGORIE = SousCategorie.LB_SOUS_CATEGORIE ;
InsertData_tmp.CD_CATEGORIE = SousCategorie.CD_CATEGORIE ;
...
} else {pstmt_tDBOutput_2.setString(1, InsertData.CD_SOUS_CATEGORIE);
}

                    if(InsertData.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, InsertData.LB_SOUS_CATEGORIE);
}

                    if(InsertData.CD_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, InsertData.CD_CATEGORIE);
}

                    if(InsertData.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, InsertData.LB_NOM_FICHIER);
}

                    if(InsertData.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(5, new java.sql.Timestamp(InsertData.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(6, InsertData.BL_LIGNE_ACTIVE);

                    if(InsertData.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7, InsertData.LB_JOB_NAME);
}
...
if(UpdateData != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    ...
                    if(UpdateData.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2 + count_tDBOutput_1, UpdateData.CD_SOUS_CATEGORIE);
}
...
if(InsertNewValueData != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(InsertNewValueData.CD_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, InsertNewValueData.CD_CATEGORIE);
}
            ...
            if(checkCount_tDBOutput_3 > 0) {
                        if(InsertNewValueData.CD_SOUS_CATEGORIE == null) {
pstmtUpdate_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(1, InsertNewValueData.CD_SOUS_CATEGORIE);
}

                        if(InsertNewValueData.LB_SOUS_CATEGORIE == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(2, InsertNewValueData.LB_SOUS_CATEGORIE);
}

                        if(InsertNewValueData.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(3, InsertNewValueData.LB_NOM_FICHIER);
}

                        if(InsertNewValueData.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(4, new java.sql.Timestamp(InsertNewValueData.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_3.setNull(4, java.sql.Types.TIMESTAMP);
}

                        pstmtUpdate_tDBOutput_3.setInt(5, InsertNewValueData.BL_LIGNE_ACTIVE);

                        if(InsertNewValueData.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(6, InsertNewValueData.LB_JOB_NAME);
}

                        if(InsertNewValueData.CD_CATEGORIE == null) {
pstmtUpdate_tDBOutput_3.setNull(7 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(7 + count_tDBOutput_3, InsertNewValueData.CD_CATEGORIE);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, InsertNewValueData.CD_SOUS_CATEGORIE);
}

                        if(InsertNewValueData.LB_SOUS_CATEGORIE == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(2, InsertNewValueData.LB_SOUS_CATEGORIE);
}

                        if(InsertNewValueData.CD_CATEGORIE == null) {
pstmtInsert_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(3, InsertNewValueData.CD_CATEGORIE);
}

                        if(InsertNewValueData.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(4, InsertNewValueData.LB_NOM_FICHIER);
}

                        if(InsertNewValueData.DT_INSERTION != null) {
pstmtInsert_tDBOutput_3.setTimestamp(5, new java.sql.Timestamp(InsertNewValueData.DT_INSERTION.getTime()));
} else {
pstmtInsert_tDBOutput_3.setNull(5, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_3.setInt(6, InsertNewValueData.BL_LIGNE_ACTIVE);

                        if(InsertNewValueData.LB_JOB_NAME == null) {
pstmtInsert_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(7, InsertNewValueData.LB_JOB_NAME);
}
...
} // End of branch "SousCategorie"




// Start of branch "CategorieManquante"
if(CategorieManquante != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(CategorieManquante.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(1, CategorieManquante.LB_CHEMIN_FICHIER);
}

                    if(CategorieManquante.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, CategorieManquante.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, CategorieManquante.NUM_LIGNE_REJET);

                    if(CategorieManquante.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, CategorieManquante.LB_LIGNE_REJET);
}

                    if(CategorieManquante.LB_MESSAGE_REJET == null) {
pstmt_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(5, CategorieManquante.LB_MESSAGE_REJET);
}

                    if(CategorieManquante.LB_NOM_FLUX == null) {
pstmt_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(6, CategorieManquante.LB_NOM_FLUX);
}

                    if(CategorieManquante.DT_REJET != null) {
pstmt_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(CategorieManquante.DT_REJET.getTime()));
} else {
pstmt_tDBOutput_6.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(CategorieManquante.LB_JOB_NAME == null) {
pstmt_tDBOutput_6.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(8, CategorieManquante.LB_JOB_NAME);
}
...
} // End of branch "CategorieManquante"
...
InsertDuplicate_tmp.LB_LIGNE_REJET = row5.CD_SOUS_CATEGORIE   + '|'+ row5.LB_SOUS_CATEGORIE + '|' + row5.CD_CATEGORIE    ;
...
InsertReject_tmp.LB_LIGNE_REJET = row5.CD_SOUS_CATEGORIE   + '|'+ row5.LB_SOUS_CATEGORIE + '|' + row5.CD_CATEGORIE    ;
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"SousCategorie");
			  	}
...
globalMap.put("tDBOutput_6_ERROR_MESSAGE",e_tDBOutput_6.getMessage());
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"CategorieManquante");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(row3,row7) outputs:(SousCategorie,CategorieManquante)
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row7.CD_CATEGORIE = null;
							} else {
	                         		
        	row7.CD_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row7.LB_CATEGORIE = null;
							} else {
	                         		
        	row7.LB_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row7.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row7.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row7.DT_INSERTION = null;
							} else {
										
			row7.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 4);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row7.BL_LIGNE_ACTIVE = 0;
							} else {
		                          
            row7.BL_LIGNE_ACTIVE = rs_tDBInput_2.getInt(5);
        	...
        	row7.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
				...
				row7_HashRow.CD_CATEGORIE = row7.CD_CATEGORIE;
				
				row7_HashRow.LB_CATEGORIE = row7.LB_CATEGORIE;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(SousCategorie,row4) outputs:(InsertData,UpdateData,InsertNewValueData)
 ...
 */
    ...
    public static void main(String[] args){
        final jOdsSousCategorie jOdsSousCategorieClass = new jOdsSousCategorie();

        int exitCode = jOdsSousCategorieClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsSousCategorie.class.getClassLoader().getResourceAsStream("icommerce_reporting/jodssouscategorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jOdsSousCategorie.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jOdsSousCategorie");
        }
...
/************************************************************************************************
 *     351778 characters generated by Talend Open Studio for Data Integration 
 *     on the 26 février 2025 à 12:11:47 GMT
 ************************************************************************************************/