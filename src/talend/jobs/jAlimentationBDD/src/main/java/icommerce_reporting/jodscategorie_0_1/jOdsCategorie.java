...
/**
 * Job: jOdsCategorie Purpose: jOdsCategorie<br>
...
public static class UpdateCategorieStruct implements routines.system.IPersistableRow<UpdateCategorieStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCategorie = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final UpdateCategorieStruct other = (UpdateCategorieStruct) obj;
	...
	public void copyDataTo(UpdateCategorieStruct other) {
	...
	public void copyKeysDataTo(UpdateCategorieStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(UpdateCategorieStruct other) {
...
UpdateCategorieStruct UpdateCategorie = new UpdateCategorieStruct();
...
InsertRejectStruct InsertReject = new InsertRejectStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"InsertCategorie");
					}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"UpdateCategorie");
					}
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"LB_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_CATEGORIE\" = ?";
 ...
 */
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"InsertNewValueCategorie");
					}
...
int count_tDBOutput_3=0;
            ...
            try (java.sql.Statement stmtCreate_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
                stmtCreate_tDBOutput_3.execute("CREATE TABLE \"" + tableName_tDBOutput_3 + "\"(\"CD_CATEGORIE\" VARCHAR(50)   not null ,\"LB_CATEGORIE\" VARCHAR(100)   not null ,\"LB_NOM_FICHIER\" VARCHAR(100)   not null ,\"DT_INSERTION\" TIMESTAMP(29)   not null ,\"BL_LIGNE_ACTIVE\" INT4  not null ,\"LB_JOB_NAME\" VARCHAR(100)   not null ,primary key(\"CD_CATEGORIE\"))");
            }
	    ...
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?)";
	    ...
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"LB_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_CATEGORIE\" = ?";
...
UpdateCategorieStruct UpdateCategorie_tmp = new UpdateCategorieStruct();
...
if(Categorie != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((!Categorie.CD_CATEGORIE.isEmpty() && !Categorie.LB_CATEGORIE.isEmpty()
...
// # Output table : 'UpdateCategorie'
UpdateCategorie_tmp.CD_CATEGORIE = row3.CD_CATEGORIE  ;
UpdateCategorie_tmp.LB_CATEGORIE = row3.LB_CATEGORIE ;
UpdateCategorie_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
UpdateCategorie_tmp.DT_INSERTION = TalendDate.getCurrentDate();
UpdateCategorie_tmp.BL_LIGNE_ACTIVE = 0;
UpdateCategorie_tmp.LB_JOB_NAME = jobName;
UpdateCategorie = UpdateCategorie_tmp;
...
// Start of branch "UpdateCategorie"
if(UpdateCategorie != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(UpdateCategorie.LB_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, UpdateCategorie.LB_CATEGORIE);
}

                    if(UpdateCategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, UpdateCategorie.LB_NOM_FICHIER);
}

                    if(UpdateCategorie.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(UpdateCategorie.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(4, UpdateCategorie.BL_LIGNE_ACTIVE);

                    if(UpdateCategorie.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, UpdateCategorie.LB_JOB_NAME);
}

                    if(UpdateCategorie.CD_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(6 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6 + count_tDBOutput_2, UpdateCategorie.CD_CATEGORIE);
}
...
} else {pstmt_tDBOutput_3.setString(1, InsertNewValueCategorie.CD_CATEGORIE);
}
...
} else {pstmtUpdate_tDBOutput_3.setString(1, InsertNewValueCategorie.LB_CATEGORIE);
}

                        if(InsertNewValueCategorie.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(2, InsertNewValueCategorie.LB_NOM_FICHIER);
}

                        if(InsertNewValueCategorie.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(InsertNewValueCategorie.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_3.setNull(3, java.sql.Types.TIMESTAMP);
}

                        pstmtUpdate_tDBOutput_3.setInt(4, InsertNewValueCategorie.BL_LIGNE_ACTIVE);

                        if(InsertNewValueCategorie.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5, InsertNewValueCategorie.LB_JOB_NAME);
}

                        if(InsertNewValueCategorie.CD_CATEGORIE == null) {
pstmtUpdate_tDBOutput_3.setNull(6 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(6 + count_tDBOutput_3, InsertNewValueCategorie.CD_CATEGORIE);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, InsertNewValueCategorie.CD_CATEGORIE);
}

                        if(InsertNewValueCategorie.LB_CATEGORIE == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(2, InsertNewValueCategorie.LB_CATEGORIE);
}

                        if(InsertNewValueCategorie.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(3, InsertNewValueCategorie.LB_NOM_FICHIER);
}

                        if(InsertNewValueCategorie.DT_INSERTION != null) {
pstmtInsert_tDBOutput_3.setTimestamp(4, new java.sql.Timestamp(InsertNewValueCategorie.DT_INSERTION.getTime()));
} else {
pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_3.setInt(5, InsertNewValueCategorie.BL_LIGNE_ACTIVE);

                        if(InsertNewValueCategorie.LB_JOB_NAME == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, InsertNewValueCategorie.LB_JOB_NAME);
}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"InsertCategorie");
			  	}
...
globalMap.put("tDBOutput_2_ERROR_MESSAGE",e_tDBOutput_2.getMessage());
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"UpdateCategorie");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"InsertNewValueCategorie");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(InsertCategorie,UpdateCategorie,InsertNewValueCategorie)
...
/************************************************************************************************
 *     294115 characters generated by Talend Open Studio for Data Integration 
