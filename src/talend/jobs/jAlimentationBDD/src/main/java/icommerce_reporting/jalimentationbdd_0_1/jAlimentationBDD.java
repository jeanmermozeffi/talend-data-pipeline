...
package icommerce_reporting.jalimentationbdd_0_1;
...
/**
 * Job: jAlimentationBDD Purpose: jAlimentationBDD<br>
 * Description: jAlimentationBDD <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jAlimentationBDD implements TalendJob {
...
public String getFieldSeparator(){
	...
	private final String jobName = "jAlimentationBDD";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jAlimentationBDD.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jAlimentationBDD.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		icommerce_reporting.jchargeods_0_1.jChargeODS childJob_tRunJob_3 = new icommerce_reporting.jchargeods_0_1.jChargeODS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		icommerce_reporting.jchargedwh_0_1.jChargeDWH childJob_tRunJob_1 = new icommerce_reporting.jchargedwh_0_1.jChargeDWH();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final jAlimentationBDD jAlimentationBDDClass = new jAlimentationBDD();

        int exitCode = jAlimentationBDDClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jAlimentationBDD.class.getClassLoader().getResourceAsStream("icommerce_reporting/jalimentationbdd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jAlimentationBDD.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jAlimentationBDD");
        }
...
/************************************************************************************************
 *     87628 characters generated by Talend Open Studio for Data Integration 
