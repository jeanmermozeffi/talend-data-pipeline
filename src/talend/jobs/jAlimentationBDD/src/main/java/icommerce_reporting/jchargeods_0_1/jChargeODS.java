 ...
 */
	...
	System.err.println("Le répertoire du jour :" + TalendDate.getDate("YYYYMMDD") + "n'existe pas !" + "Veuillez déposer le fichier du jour et relancer l'intégration.");
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le répertoire du jour :" + TalendDate.getDate("YYYYMMDD") + "n'existe pas !" + "Veuillez déposer le fichier du jour et relancer l'intégration.");
	globalMap.put("tDie_1_DIE_MESSAGES", "Le répertoire du jour :" + TalendDate.getDate("YYYYMMDD") + "n'existe pas !" + "Veuillez déposer le fichier du jour et relancer l'intégration.");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    parentContextMap_tRunJob_1.put("schema_params", context.schema_params);
                    paraList_tRunJob_1.add("--context_type " + "schema_params" + "=" + "id_String");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_2 {
                    ...
                    parentContextMap_tRunJob_2.put("schema_params", context.schema_params);
                    paraList_tRunJob_2.add("--context_type " + "schema_params" + "=" + "id_String");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_3 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_3 {
                    ...
                    parentContextMap_tRunJob_3.put("schema_params", context.schema_params);
                    paraList_tRunJob_3.add("--context_type " + "schema_params" + "=" + "id_String");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_4 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_4 {
                    ...
                    parentContextMap_tRunJob_4.put("additinal_params", context.additinal_params);
                    paraList_tRunJob_4.add("--context_type " + "additinal_params" + "=" + "id_String");
                    ...
                    parentContextMap_tRunJob_4.put("postgres_password", context.postgres_password);
                    paraList_tRunJob_4.add("--context_type " + "postgres_password" + "=" + "id_Password");
                    parentContextMap_tRunJob_4.put("postgres_user", context.postgres_user);
                    paraList_tRunJob_4.add("--context_type " + "postgres_user" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("schema_params", context.schema_params);
                    paraList_tRunJob_4.add("--context_type " + "schema_params" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("server_name", context.server_name);
                    paraList_tRunJob_4.add("--context_type " + "server_name" + "=" + "id_String");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_5 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_5 {
                    ...
                    parentContextMap_tRunJob_5.put("additinal_params", context.additinal_params);
                    paraList_tRunJob_5.add("--context_type " + "additinal_params" + "=" + "id_String");
                    ...
                    parentContextMap_tRunJob_5.put("postgres_password", context.postgres_password);
                    paraList_tRunJob_5.add("--context_type " + "postgres_password" + "=" + "id_Password");
                    parentContextMap_tRunJob_5.put("postgres_user", context.postgres_user);
                    paraList_tRunJob_5.add("--context_type " + "postgres_user" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("schema_params", context.schema_params);
                    paraList_tRunJob_5.add("--context_type " + "schema_params" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("server_name", context.server_name);
                    paraList_tRunJob_5.add("--context_type " + "server_name" + "=" + "id_String");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_6 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_6 {
                    ...
                    parentContextMap_tRunJob_6.put("schema_params", context.schema_params);
                    paraList_tRunJob_6.add("--context_type " + "schema_params" + "=" + "id_String");
...
/************************************************************************************************
 *     152875 characters generated by Talend Open Studio for Data Integration 
 *     on the 26 février 2025 à 12:11:49 GMT
 ************************************************************************************************/